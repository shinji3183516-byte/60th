...
const timelineData = [
  {
    ...
    "title": "高岡工場スタート",
    "visual": "PLANT",
    "car": "高岡工場は、モータリゼーションを支える生産拠点として歩みを始めました。翌年、元町工場から「パプリカ」の生産を移管。1968年には「スプリンター」の生産開始",
    "carImage": "images/car/パブリカ.jpg",
    "factory": "工場の歩みの起点。生産車種と工場の歴史をここから紹介します。",
    "factoryImage": "images/factory/takaoka_1gousha.jpg",
    "society": "高度経済成長の中で、家庭に車が広がっていく時代でした。初代トヨタ・カローラ発売。ビートルズが来日し、日本武道館で公演。ウルトラマン放送開始。笑点 放送開始",
  ...
  },
  {
    ...
    "factoryImage":"images/factory/akechi.jpg",
  ...
  },
  {
    ...
    "factoryImage": "images/factory/nummi1.jpg",
